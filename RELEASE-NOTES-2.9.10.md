...
Existing users do not lose permissions when upgrading. Existing Read grants become Viewer grants, while existing Write grants become Manager grants so that users retain every capability they previously had. The new Editor role provides a more flexible level of access for collaborators.
